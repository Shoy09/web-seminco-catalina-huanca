...
@Component({
  selector: 'app-produccion-mes',
  standalone: true,
  imports: [NgxEchartsDirective],
  providers: [provideEchartsCore({ echarts })],
  templateUrl: './produccion-mes.component.html',
  styleUrl: './produccion-mes.component.css',
})
export class ProduccionMesComponent implements OnChanges {
  @Input() data: any[] = [];
  chartOptions: any = {};
  ...
  actualizarGrafico(): void {
    ...
    const escalaMax = Math.ceil(maxValor / 100) * 100;
