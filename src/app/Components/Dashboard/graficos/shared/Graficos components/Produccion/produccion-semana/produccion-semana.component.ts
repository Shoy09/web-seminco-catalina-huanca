...
@Component({
  selector: 'app-produccion-semana',
  standalone: true,
  imports: [NgxEchartsDirective],
  providers: [provideEchartsCore({ echarts })],
  templateUrl: './produccion-semana.component.html',
  styleUrl: './produccion-semana.component.css',
})
export class ProduccionSemanaComponent implements OnChanges {
  @Input() data: any[] = [];
  chartOptions: any = {};
