...
@Component({
  selector: 'app-rendimiento-mes',
  standalone: true,
  imports: [NgxEchartsDirective],
  providers: [provideEchartsCore({ echarts })],
  templateUrl: './rendimiento-mes.component.html',
  styleUrl: './rendimiento-mes.component.css',
})
export class RendimientoMesComponent implements OnChanges {
  @Input() data: any[] = [];
  ...
  actualizarGrafico(): void {
    ...
    const porcentajeVisible = meses.length > 6
      ? (6 / meses.length) * 100
      : 100;
