...
@Component({
  selector: 'app-disponibilidad-dia-mes',
  standalone: true,
  imports: [NgxEchartsDirective],
  providers: [provideEchartsCore({ echarts })],
  templateUrl: './disponibilidad-dia-mes.component.html',
  styleUrl: './disponibilidad-dia-mes.component.css'
})
export class DisponibilidadDiaMesComponent
